<div class="span3" style="width: 260px">
    <div class="well sidebar-nav">
        <ul class="nav nav-list">
            <li class="nav-header frame-menu">字符串工具</li>
            <li class="active"><a href="<@spring.url relativeUrl='/str/split'/>">字符串拆分</a></li>
            <li><a href="<@spring.url relativeUrl='/str/jsonfmt'/>">Json格式化</a></li>
            <li class="nav-header frame-menu">Http工具</li>
            <li><a href="<@spring.url relativeUrl='/http/dopost'/>">模拟Http请求</a></li>
